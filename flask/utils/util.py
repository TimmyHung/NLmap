...
def save_queryLog(user_id, query, model_name, prompt_tokens, completion_tokens, total_tokens, valid):
    cursor, connection = get_db_cursor()
    # try:
    sql = "INSERT INTO query_logs (user_id, query, model_name, prompt_tokens, completion_tokens, total_tokens, valid) VALUES (%s, %s, %s, %s, %s, %s, %s)"
    cursor.execute(sql, (user_id, query, model_name, prompt_tokens, completion_tokens, total_tokens, valid))
    connection.commit()
